...
export default function AddSchoolScreen({ navigation }) {
  ...
  const handleSubmit = async () => {
    ...
    setLoading(true);
    try {
      await schoolsService.createSchool(formData);
      ...
      Alert.alert('Erro', error.error || 'Não foi possível cadastrar a escola');
  ...
  return (
    <ScrollView style={styles.container}>
      ...
      <Button
        title={loading ? 'Cadastrando...' : 'Cadastrar Escola'}
